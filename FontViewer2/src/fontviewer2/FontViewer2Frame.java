...
public class FontViewer2Frame extends JFrame{
    ...
    public FontViewer2Frame()
    {
        ...
        JLabel sampleField = new JLabel("Big Java");
    ...
    public JMenu createFaceMenu()
    {
        ...
        menu.add(createFaceItem("Dimitrios"));
        menu.add(createFaceItem("Malonas"));
     ...
     * @param ds the amountby which to change the size
     * @return the menu item
     */
    public JMenuItem createSizeItem(String name, final int ds)
    {
        ...
        class MenuItemListener implements ActionListener
        {
            public void actionPerformeed(ActionEvent event)
            {
