...
public class Html2text3 {
    ...
    public final static void main(String[] args) throws Exception {
        ...
        Html2text3.urlloader(new URL("https://en.wikipedia.org/wiki/Cybernetics"));
  ...
  //  }
    ...
    List<String> list1 = Html2text3.extractText(reader);
...
System.out.println(start);
      ...
      //read file for sentences and put them in mysql
		Html2text3.sentenc2mysq("text2.html");
		 ...
		 // while (res.next()) {
		  ...
		  //System.out.println(id + "\t" + msg);
			...
			System.out.println(e.getMessage());
                    ...
                    Logger.getLogger(Html2text3.class.getName()).log(Level.SEVERE, null, ex);
                    }		  
            }
				...
				while ((sentenceLine = br1.readLine()) != null)   {
					  // Print the content on the console
                                          // System.out.println(sentenceLine);
                                            Html2text3.write2mysql(sentenceLine);
					}
