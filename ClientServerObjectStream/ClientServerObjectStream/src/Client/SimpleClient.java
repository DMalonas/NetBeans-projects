...
/**
 * A simple client with a single window frame. Sends a Voucher to the server and
 receives Voucher as reply.
 *
 * @author Chris Bass
 * @date 06/04/2016
 */
public class SimpleClient extends Frame {
    ...
    private void sendToServer() {
        if (objectOutputStream != null && objectInputStream != null) {
            ...
            try {
                objectOutputStream.writeObject(new Voucher(toSend, null));
            } catch (IOException ex) {
            ...
            try {
                reply = (Voucher) objectInputStream.readObject();
