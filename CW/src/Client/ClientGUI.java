...
public class ClientGUI extends javax.swing.JFrame {
    ...
    public ClientGUI() {
        initComponents();   
        randomVoucherCodeGenerator(list);
    }
    ...
    public void randomVoucherCodeGenerator( ArrayList<Integer> list){
        for (int i=1; i<30000; i++) {
            list.add(new Integer(i));
        }
        System.out.println("OUPUSSSPUS");
    ...
    public void delay2Secs(){
        try {
            ...
            Logger.getLogger(ClientGUI.class.getName())
