 ...
 *
 * @author Dimitrios
 * A component that lets the user enter a number, using a keypad labeled with digits
 */
public class KeyPad extends JPanel
{
    ...
    ActionListener listener = new ClearButtonLitener();
 ...
 * @return the value in the text field or keypad
 */
