...
public class ViewAllVouchersFrame extends javax.swing.JInternalFrame {
    ...
    protected ArrayList<Voucher> listVouchers;
        ...
        try
        {
            ...
            if (connectToServer() > 0)
            {
                ...
                Collections.sort(listVouchers, new Comparator<Voucher>() {
                    ...
                    {
                        return  voucher1.getPurchaserName().
                                compareTo(voucher2.getPurchaserName());
                    }
                });
		...
		while (myVoucherIterator.hasNext())
                {
                    ...
                    model.addRow(new Object[]{tempVoucher.getVoucherCode(),
                        tempVoucher.getPurchaserName(), 
                        tempVoucher.getGift() ? "YES":"NO",
                        tempVoucher.getRedeemed() ? "YES":"NO", 
    ...
    {
        ViewVoucherDetailsFrame viewVoucherDetailsFrame =
                new ViewVoucherDetailsFrame(listVouchers.get(row));
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Double click on an item to view details");
    ...
    protected void receiveVouchers()
    {
        try
        {
