 ...
 *
 * @author Dimitrios
 * tHIS CLAsS SORTS AN ARRAY, USING THE SELCTION SORT ALGORITHM 
 */
class SelectionSorter{
    ...
    //The componenet is repainted when the animation is paused
     ...
     * @param return the position of the smallest element in the range a[from]  . . . a[a.length-1]
     */
