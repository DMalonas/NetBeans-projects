...
public class BankService implements Runnable 
{
    ...
    /**
     * Executes all commands until the QUIT command of the end of input
     * 
    */
    public void doService() trhows IOException
    {
        while(true)
        {
            if(!in.hasNext())return;
            String command = in.next();
            if(command.equals("OUIT"))return;
     ...
     * @param ocmmand the command to execute
     */
