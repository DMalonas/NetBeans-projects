...
public class ClientProgramSerialised extends Frame implements ActionListener {
   ...
   ClientProgramSerialised(String title) {
      super(title);
   ...
   public static void main(String[] args) {
      new ClientProgramSerialised("Client 2 Example - Transfer Whole Objects");
   }  // end main method
