...
public class CompleteVoucherFrame extends javax.swing.JInternalFrame
{
    ...
    private void initComponents() {
        ...
        jLabel27.setText("Complete Voucher");
    ...
    private void jComboBox4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jComboBox4ActionPerformed
        ...
        jLabel20.setText(tempVoucher.getFlightDate().substring(0,10)+
                ", " +tempVoucher.getPurchaseDate().substring(23,28));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try
        {
            ...
            String flightDuration = jComboBox1.getSelectedItem().toString() + 
                    "h " + jComboBox2.getSelectedItem().toString() + "m";
            String gliderNumber = jTextField1.getText();
            String glidingInstructor = jTextField2.getText();
            
            // We use the convenient constructor
            CompletedVoucher newCompletedVoucher = 
                    new CompletedVoucher(listVouchers.get(voucherIndex),
                            flightDuration, gliderNumber, glidingInstructor);
            // Send voucher to complete
            // Send object (voucher) to the server 
            ...
            JOptionPane.showMessageDialog(null, 
                    "Voucher successfully completed.",
    ...
    private void receiveRedeemedVouchers()
    {
        try
        {
            //populate RedeemedVoucher objects inside listVouchers arrayList
            try {
