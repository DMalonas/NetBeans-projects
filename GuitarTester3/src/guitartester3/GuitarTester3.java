package guitartester3;

import java.util.Iterator;
import java.util.List;

public class GuitarTester3 {
    ...
    public static void main(String[] args) {
        ...
        GuitarSpec whatIwant = 
                new GuitarSpec(Builder.FENDER, "Stratocastor",
                               Type.ELECTRIC, Wood.ALDER, Wood.ALDER);
                List matchingGuitars  = inventory.search(whatIwant);
                if (!matchingGuitars.isEmpty()) {
                    System.out.println("Dimitrios you might like these guitars:");
                    for (Iterator i = matchingGuitars.iterator(); i.hasNext(); ) {
                        ...
                        System.out.println(" We have a  " +
                            ...
                            spec.getTopWood() + " top.\n You can have it for onnly $" +
                            guitar.getPrice() + "!\n --------------");
                    }
                } else {
                    System.out.println("Sory, Dimitrios, we dont have that");
                }
    }
