/* A simple client with a single window, two textfields and buttons
27th March 02

The buttons: disconnect from the server,
             send the employee name in the textfield to the server

The server will send the email address which is shown in the second textfield.
*/
...
public class ClientExample extends Frame implements ActionListener{
  ...
  public static void main(String[] args){
    ClientExample c=new ClientExample("Clint Example");
  }
