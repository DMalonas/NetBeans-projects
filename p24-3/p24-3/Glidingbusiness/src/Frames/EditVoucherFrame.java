...
public class EditVoucherFrame extends javax.swing.JInternalFrame {
    ...
    /* It is the memory that keeps/edits temp data
       from DB for better speed performance     */
    private ArrayList<NonRedeemedVoucher> listVouchers;
    //Create InputStream to read the initial Voucher data from the server
    private ObjectInputStream serverInputStream;   
    //  Create OutputStream to write to the server the modifications
    private ObjectOutputStream clientOutputStream;
    //Create Socket to operate the streams through it
    private Socket socket;
    
    
    /** Create new form EditVoucherFrame */
    public EditVoucherFrame() {
        ...
        try
        {
            ...
            if (connectToServer() > 0)
            {
                ...
                // Populate vouchers in the form with Iterator 
    ...
    private void receiveNonRedeemedVouchers()
    {
        try
        {
            try {
                ...
                Logger.getLogger(EditVoucherFrame.class.getName()).
                        log(Level.SEVERE, null, ex);
            }
        }
        catch (IOException ex) {
